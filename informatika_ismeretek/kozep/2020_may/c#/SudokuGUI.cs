...
public class SudokuGUI {
    ...
    public static void HandleMinusDimensionButtonPress(TextBox dimensionField) {
    ...
    public static void HandlePlusDimensionButtonPress(TextBox dimensionField) {
        var oldValue = int.Parse(dimensionField.Text);
    ...
    public static void HandleCheckButtonPress(TextBox dimensionBox, TextBox userTextInput) {
