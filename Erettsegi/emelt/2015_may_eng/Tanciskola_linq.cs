...
namespace Prog{
    class Tanciskola_linq{
        static void Main(string[] args){
            ...
            string tancNev = Console.ReadLine();
            ...
            using(StreamWriter output = new StreamWriter("szereplok.txt")){
                output.Write("Lányok: ");
                output.Write(lanyok
                      .Select(k => k.Key)
                      .Aggregate((k, l) => k + ", " + l));
            ...
            Console.WriteLine("A legtöbbször táncolt lányok: " + lanyok
                .Where(k => k.Value == lanyok.First().Value)
                .Select(k => k.Key)
                .Aggregate((k, l) => k + ", " + l));

            Console.WriteLine("A legtöbbször táncolt fiúk: " + fiuk
                .Where(k => k.Value == fiuk.First().Value)
                .Select(k => k.Key)
                .Aggregate((k, l) => k + ", " + l));
