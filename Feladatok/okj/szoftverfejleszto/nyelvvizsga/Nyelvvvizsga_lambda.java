...
public class Nyelvvvizsga_lambda {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("2. Feladat: Legnépszerûbb nyelvek");
		...
		try(var input = new Scanner(System.in)){
			...
			Arrays.stream(nyelvvizsgak)
				  ...
				  .ifPresent(k -> System.out.printf(beEv + "-ben " + k.nyelv + "-bõl volt a legnagyobb bukási arány: %.2f%%\n", k.getBukasAtlag(beEv)));
			...
			if(nincsVizsgazo.length == 0) {
				System.out.println("Minden nyelvbõl volt vizsgázó");
			}else{
