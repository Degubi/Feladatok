...
public class Cbradio {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if(voltE4Adasos) {
            System.out.println("4. Feladat: Volt 4 adást indító sofõr");
        }else {
            System.out.println("4. Feladat: Nem volt 4 adást indító sofõr");
        }
        ...
        try(var console = new Scanner(System.in)){
            ...
            if(bekertHasznalatok > 0) {
                ...
                System.out.println("Nincs ilyen nevû sofõr!");
            }
        }
        ...
        System.out.println("8. Feladat: Sofõrök száma: " + egyediSoforok.size());
        ...
        //Elég ronda módszer az elsõ elem lekérésére, de kell valami amihez képest összehasonlítani tudunk. :/
        ...
        System.out.println("9. Feladat: Legtöbb adást indító sofõr: " + legtobbAdasBejegyzes.getKey() + ", adások: " + legtobbAdasBejegyzes.getValue());
    }
