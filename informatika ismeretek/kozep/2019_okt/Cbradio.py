...
if voltE4Adasos:
    print("4. Feladat: Volt 4 adást indító sofõr")
else:
    print("4. Feladat: Nem volt 4 adást indító sofõr")
...
print("9. Feladat: Legtöbb adást indító sofõr: " + legtobbAdasBejegyzes[0] + ", adások: " + str(legtobbAdasBejegyzes[1]))