...
public class Ultrabalaton {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("4. Feladat: Célbaért nõi versenyzõk: " + celbaertNoiVersenyzok);
        ...
        System.out.println("7. Feladat: Átlagos idõ: " + (ferfiAtlagIdo / ferfiakSzama));
