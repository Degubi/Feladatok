...
public class Sorozatok {
    ...
    public static void Main(string[] args) {
        ...
        var kiirando = bekertNapraEsok.Count == 0 ? "Az adott napon nem kerül adásba sorozat."
                                                  : string.Join("\n", bekertNapraEsok);
    ...
    public static readonly string[] napok = { "v", "h", "k", "sz", "cs", "p", "szo" };
    public static readonly int[] honapok = { 0, 3, 2, 5, 0, 3, 5, 1, 4, 6, 2, 4 };
