...
public class Hianyzasok {
    ...
    public static void Main(string[] args) {
        ...
        Console.WriteLine("Ekkor " + hianyzottak + "-an hiányoztak");
    ...
    public static readonly String[] napnev = { "vasarnap", "hetfo", "kedd", "szerda", "csutortok", "pentek", "szombat" };
    public static readonly int[] napszam = { 0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 335 };
