...
namespace ConsoleApplication1{
    class SMS_linq{
        ...
        var smss = Enumerable.Range(1, file.Length - 1)
                             .Where(k => k % 2 == 1)
        ...
        using(var output = new StreamWriter("smski.txt")){
            Console.WriteLine("Írd be a hiányzó üzenetet! (Óra perc szám üzenet)");
            var missing = new Uzenet(new [] {Console.ReadLine(), Console.ReadLine(), Console.ReadLine()}, Console.ReadLine());
