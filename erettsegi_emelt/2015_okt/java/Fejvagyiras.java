...
public class Fejvagyiras {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var bekertFI = System.console().readLine("2. Feladat: Tippelj! (F/I): ");
        var generaltFI = random.nextBoolean() ? 'I' : 'F';

        System.out.println(bekertFI.charAt(0) == generaltFI ? "Eltaláltad!" : "Nem talált!");
