...
int main(){
    ...
    cout << "Első vásárló által vásárolt dolgok száma: " << vasarlasok[0].cuccok.size() << endl;
    cout << "Első vásárló által vásárolt dolgok: " << endl;
    ...
    cout << "Először ekkor vettek " << cikknev << "-t: " << first << ". vásárlás" << endl;
    cout << "Utoljára ekkor vettek " << cikknev << "-t: " << last << ". vásárlás" << endl;
    cout << "Összesen ennyiszer vettek " << cikknev << "-t: " << cikkCounter << endl;
    cout << dbszam << "db termék esetén a fizetendő: " << ertek(dbszam) << endl;
