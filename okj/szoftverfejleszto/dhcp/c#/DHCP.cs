...
public class DHCP {
    ...
    public static void RunTest(string type, string address, Dictionary<string, string> dhcp, string[] excluded, Dictionary<string, string> reserved) {
    ...
    public static string CreateIP(string macAddress, Dictionary<string, string> dhcp, string[] excluded, Dictionary<string, string> reserved) {
