...
public class FifaVilagRanglista_stream {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var szerepeltEMo = Arrays.stream(eredmenyek).anyMatch(k -> k.csapat.equals("Magyarország"));

        System.out.println(szerepeltEMo ? "6. Feladat: Csapatok között van Magyarország" : "6. Feladat: Csapatok között nincs Magyarország");
